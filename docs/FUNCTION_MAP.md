...
| `EducationalPreviewDialog`, `EducationalPreviewDialog.__init__`, `EducationalPreviewDialog._summary_selection_changed`, `EducationalPreviewDialog._update_approve_button`, `EducationalPreviewDialog._set_read_only`, `EducationalPreviewDialog._axis_selector` | `educational_preview.py` | Build the destination-grouped summary, filter the fixed-choice details, show the approved count, and retain explicit unresolved state and allowed roots. |
