...
| `E5SubjectClassifier`, `E5SubjectClassifier.__init__`, `E5SubjectClassifier._profile_embeddings`, `E5SubjectClassifier._lexical_scores`, `E5SubjectClassifier._filename_scores`, `E5SubjectClassifier.classify` | `classification/e5.py` | Cache averaged profile vectors, score bounded Kiwi terms separately against inspectable natural profiles, resolve at most one catalog-bounded subject via longest filename-alias match, rank only catalog subjects, and retain each contribution plus top-two margin. |
